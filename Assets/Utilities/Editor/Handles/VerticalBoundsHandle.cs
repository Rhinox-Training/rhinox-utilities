...
namespace Rhinox.Utilities.Editor
{
    public class VerticalBoundsHandle
    {
        ...
        /// </summary>
        public float ScreenspaceHandleSize
        {
            get => screenspaceHandleSize;
            set => screenspaceHandleSize = value;
        }
        ...
        /// </summary>
        public Handles.CapFunction HandleCapFunction
        {
            get => handleCapFunction;
            set => handleCapFunction = value;
        }
        ...
        {
            get => drawGuidelineCallback;
            set => drawGuidelineCallback = value;
        }
        ...
        public bool DrawHandle()
        {
            ...
            using (new Handles.DrawingScope(HandleColor, handleSpace))
            {
                ...
                using (var check = new EditorGUI.ChangeCheckScope())
                {
                    ...
                    var newBottomPosition = Handles.Slider(bottomPosition, direction, bottomSize, HandleCapFunction,
                        actualSnap);
                    if (check.changed)
                    {
        ...
        /// </summary>
        /// <returns>Returns true if the top or bottom was changed.</returns>
        public bool DrawHandle(float top, float bottom, Vector3 position, Quaternion rotation, Vector3 scale,
            Vector3 direction)
        {
            this.Top = top;
            this.Bottom = bottom;
