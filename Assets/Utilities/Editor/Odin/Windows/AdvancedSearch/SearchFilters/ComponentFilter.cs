...
public class ComponentFilter : BaseAdvancedSearchSearchFilter
{
    ...
    private bool OdinComponentMatch(Component component, TypeSearchData searchData)
    {
        ...
        foreach (var serializedVarData in searchData.SerializedVars)
        {
            ...
            if (!AreInspectorPropertiesEqualValue(property.ValueEntry, dummyProperty.ValueEntry, serializedVarData.Comparer))
                return false;
        }
    ...
    private bool AreInspectorPropertiesEqualValue(IPropertyValueEntry prop, IPropertyValueEntry dummyProp, CompareMethod compareMethod)
    {
    ...
    private static bool AreSerializedPropertiesEqualValue(SerializedProperty property, SerializedProperty dummyProperty, CompareMethod compareMethod)
    {
        switch (property.propertyType)
        {
            case SerializedPropertyType.Generic:
                ...
                {
                    if (!AreSerializedPropertiesEqualValue(property.GetArrayElementAtIndex(i), dummyProperty.GetArrayElementAtIndex(i), compareMethod))
                        return false;
                }
            ...
            case SerializedPropertyType.Float:
                if (compareMethod.HasFlag(CompareMethod.Equals) && Math.Abs(property.floatValue - dummyProperty.floatValue) <= float.Epsilon)
                    return true;
            ...
            case SerializedPropertyType.Vector2:
                if (compareMethod.HasFlag(CompareMethod.Equals) && property.vector2Value == dummyProperty.vector2Value)
                    return true;
            ...
            case SerializedPropertyType.Vector3:
                if (compareMethod.HasFlag(CompareMethod.Equals) && property.vector3Value == dummyProperty.vector3Value)
                    return true;
            ...
            case SerializedPropertyType.Vector4:
                if (compareMethod.HasFlag(CompareMethod.Equals) && property.vector4Value == dummyProperty.vector4Value)
                    return true;
            ...
            case SerializedPropertyType.Gradient:
                throw new NotImplementedException("Gradient comparison for SerializedProperties has not been implemented. TODO.");
